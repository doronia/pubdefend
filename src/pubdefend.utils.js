...
export const isReady = function(callback) {
    if (isReady) {
        callback();
    } else {
...
export const log = function(args) {
    if (window.pubDefend.debug && window.console.log(args));
    return;
}
...
export const getHostName = function(e) {
    var t = [{ key: "?", index: 0 }, { key: "://", index: 1 }, { key: "//", index: 1 }, { key: "/", index: 0 }, { key: ":", index: 0 }],
        n = 0,
        o = t.length,
        a = e,
        r;
